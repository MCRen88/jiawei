...
# from features_his_tsfresh import drag_from_tsfresh, ComprehensiveFCParameters
...
def time_series_maximum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.maximum(x)
...
def time_series_minimum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.minimum(x)
...
def time_series_mean(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.mean(x)
...
def time_series_variance(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.variance(x)
...
def time_series_standard_deviation(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.standard_deviation(x)
...
def time_series_skewness(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.skewness(x)
...
def time_series_kurtosis(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.kurtosis(x)
...
def time_series_median(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.median(x)
...
def time_series_abs_energy(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.abs_energy(x)
...
def time_series_absolute_sum_of_changes(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.absolute_sum_of_changes(x)
...
def time_series_variance_larger_than_std(x):
    ...
    :return type: int
    """
    return int(ts_feature_calculators_without_param.variance_larger_than_standard_deviation(x))
...
def time_series_count_above_mean(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.count_above_mean(x)
...
def time_series_count_below_mean(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.count_below_mean(x)
...
def time_series_first_location_of_maximum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.first_location_of_maximum(x)
...
def time_series_first_location_of_minimum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.first_location_of_minimum(x)
...
def time_series_last_location_of_maximum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.last_location_of_maximum(x)
...
def time_series_last_location_of_minimum(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.last_location_of_minimum(x)
...
def time_series_has_duplicate(x):
    ...
    :return type: bool
    """
    return ts_feature_calculators_without_param.has_duplicate(x)
...
def time_series_has_duplicate_max(x):
    ...
    :return type: bool
    """
    return ts_feature_calculators_without_param.has_duplicate_max(x)
...
def time_series_has_duplicate_min(x):
    ...
    :return type: bool
    """
    return ts_feature_calculators_without_param.has_duplicate_min(x)
...
def time_series_longest_strike_above_mean(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.longest_strike_above_mean(x)
...
def time_series_longest_strike_below_mean(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.longest_strike_below_mean(x)
...
def time_series_mean_abs_change(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.mean_abs_change(x)
...
def time_series_mean_change(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.mean_change(x)
...
def time_series_percentage_of_reoccurring_datapoints_to_all_datapoints(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.percentage_of_reoccurring_datapoints_to_all_datapoints(x)
...
def time_series_ratio_value_number_to_time_series_length(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.ratio_value_number_to_time_series_length(x)
...
def time_series_sum_of_reoccurring_data_points(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.sum_of_reoccurring_data_points(x)
...
def time_series_sum_of_reoccurring_values(x):
    ...
    :return type: float
    """
    return ts_feature_calculators_without_param.sum_of_reoccurring_values(x)
...
def time_series_sum_values(x):
    ...
    :return type: bool
    """
    return ts_feature_calculators_without_param.sum_values(x)
